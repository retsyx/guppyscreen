...
if [ "$ARCH" = "aarch64" ]; then
    ...
    ASSET_URL="https://github.com/retsyx/guppyscreen/releases/latest/download/guppyscreen-arm.tar.gz"
    if [ "$1" = "nightly" ]; then
        printf "${yellow}Installing nightly build ${white}\n"
        ASSET_URL="https://github.com/retsyx/guppyscreen/releases/download/nightly/guppyscreen-arm.tar.gz"
    fi
